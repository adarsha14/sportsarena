...
//     })
return axios.get(`http://13.57.146.21:8080/booking-Management/api/v1/slotslist/groundID/`+location.state.groundID)
 .then((res)=>{
...
const getdetailview = () => {
  console.log("id");
    axios.get(`http://13.57.146.21:8080/user/api/v1/ground/groundID/`+location.state.groundID)
    .then((res)=>{
