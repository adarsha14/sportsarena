...
function TeamUp() {
  ...
  const filterTeamup = () => {
    axios.get("http://13.57.146.21:3000/teamup")
      .then((res) => {
  ...
  const filterData = () => {
    setCurrentTab(1);
    axios
      .get("http://13.57.146.21:8080/user/api/v1/playerlist")
      .then((res) => {
        console.log(res.data);
         let value=[];
  ...
  async function Team_up(userEmail) {
    ...
    await axios
      .post("http://13.57.146.21:8080/team/api/v1/teamup/sendInvite", {
  ...
  const deleteid = (id) => {
    console.log(id)
    axios.delete(`http://13.57.146.21:8080/team/api/v1/teamup/removeinvite/requestId/${id}`)
      .then((res) => {
        console.log(res);
        sentInviteTab();
      }).catch((err) => console.log(err));
  ...
  const updateStatus = (teamup_id) => {
    ...
    axios.put(`http://13.57.146.21:8080/team/api/v1/teamup/action/requestId/${teamup_id}/requestStatus/${statusOfRequest}`)
      .then((res) => {
        console.log(res)
        myInvite();
      })
  ...
  const myInvite = () => {
    ...
    axios
      .get(`http://13.57.146.21:8080/team/api/v1/teamup/requestedPlayerEmail/${reqEmail}`)
      .then((res) => {
        console.log(res.data);
        let invitedatas = [];
        res.data.map((el) => {
  ...
  const sentInviteTab = () => {
    ...
    axios
      .get(`http://13.57.146.21:8080/team/api/v1/teamup/senderEmail/${senderEmail}`)
      .then((res) => {
        console.clear();
