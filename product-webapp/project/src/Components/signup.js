...
function Signup() {
    ...
    const postDetails = () => {
        if (formValues.role === "player") {
            axios
                .post("http://54.176.95.76:3000/players",
            ...
            axios
                .post("http://54.176.95.76:3000/vendors",
    ...
    const updateDetails = () => {
        ...
        axios.put("http://54.176.95.76:3000/newplayer/1", values)
            .then(res => console.log(res.data)).catch((error) => { console.log(error) })
    }

    const deleteDetails = () => {
        axios.delete("http://54.176.95.76:3000/newplayer/3").
            then((response) => {
                console.log(response)
